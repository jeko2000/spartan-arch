...
pacman -S --noconfirm git emacs zsh nodejs npm vim wget perl make gcc grep tmux i3 dmenu w3m the_silver_searcher aspell aspell-en aspell-es
...
pacman -S --noconfirm python-pip go go-tools pkg-config python-pipenv ipython python-requests yapf python-jedi
...
wget https://raw.githubusercontent.com/jeko2000/spartan-arch/master/post-install.sh -O /home/$user/post-install.sh
